...
public:
    ...
    void killHero();
    void getParameter(int parCode, char answer[], int &len); // в чар будем класть всё, тк у нас в стринг может попасть символ концы строки
    ...
    void codeHero(char code[], int &len);
